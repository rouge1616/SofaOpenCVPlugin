...
{
public:
    SOFA_CLASS(SOFA_TEMPLATE(VideoReader,DataTypes),core::DataEngine);
...
public:
    ...
    static std::string templateName(const VideoReader<DataTypes>* = NULL)
    {
...
#if defined(SOFA_EXTERN_TEMPLATE) && !defined(SOFA_COMPONENT_ENGINE_VideoReader_CPP)

#ifndef SOFA_FLOAT
extern template class SOFA_ENGINE_API VideoReader<defaulttype::Vec3dTypes>;
#endif //SOFA_FLOAT
#ifndef SOFA_DOUBLE
extern template class SOFA_ENGINE_API VideoReader<defaulttype::Vec3fTypes>;
#endif //SOFA_DOUBLE
#endif
